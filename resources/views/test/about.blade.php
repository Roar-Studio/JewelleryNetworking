...
<body>
  ...
  <div class="announce">Inaugural Edition | 2026 <span class="pipe">|</span> Registration opens soon <span class="pipe">|</span> <a href="{{ url('/test/contact') }}">Be notified &rarr;</a></div>
  <nav>
    ...
    <div class="nav-links">
      ...
      <a href="{{ url('/test/about') }}" class="nav-link active">About</a>
  ...
  <div class="mobile-menu-drawer">
    ...
    <div class="mobile-menu-links">
      ...
      <a href="{{ url('/test/about') }}" class="mob-link active">About</a>
