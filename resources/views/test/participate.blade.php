...
<section
    ...
    style="background-image:url('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/participate.png');
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="p-panel active" id="tab-how-to-enter">
        ...
        <a href="{{ url('/test/submit') }}" class="btn-gold" style="display:inline-flex;align-items:center;gap:.75rem;margin-top:2.5rem"><span>Begin Your Submission</span><span class="arrow">&#x2192;</span></a>
      </div>
