...
<body>
  ...
  <!--  PAGE LOADER  -->
  <div id="dda-loader">
    <img src="{{ asset('testdda/Logo/Logo_1_horizontal_color.svg') }}" alt="Deities Design Awards" id="dda-loader-logo">
  ...
  <div class="announce">
    Inaugural Edition | 2026 <span class="pipe">|</span> Registration opens soon <span class="pipe">|</span> <a
      href="{{ url('/test/contact') }}">Be notified &rarr;</a>
  </div>

  <!--  NAV  -->
  <nav>
    <a href="#" class="nav-logo"><img src="{{ asset('testdda/Logo/Logo_1_horizontal_color.svg') }}" alt="Deities Design Awards"></a>
  ...
  <section class="hero">
    ...
    <div class="hero-content">
      <img src="{{ asset('testdda/Logo/Logo_1_horizontal_color.svg') }}" alt="Deities Design Awards" class="hero-logo-mark">
      ...
      <div class="hero-cta-row">
        <a href="{{ url('/test/submit') }}" class="btn-gold pulse">
          <span>Register Now</span>
          <span class="arrow">&rarr;</span>
        </a>
        <a href="{{ url('/test/about') }}" class="btn-primary">
  ...
  <section class="section categories">
    <div class="container">
      ...
      <div class="cat7-grid">
        <a href="{{ url('/test/design-category') }}#nitai" class="cat7-item">
          <h4>Nitai</h4>
          <span class="cat-explore">Explore Category <span>&rarr;</span></span>
        </a>
        <a href="{{ url('/test/design-category') }}#gaur" class="cat7-item">
          <h4>Gaur</h4>
          <span class="cat-explore">Explore Category <span>&rarr;</span></span>
        </a>
        <a href="{{ url('/test/design-category') }}#lalita" class="cat7-item">
          <h4>Lalita</h4>
          <span class="cat-explore">Explore Category <span>&rarr;</span></span>
        </a>
        <a href="{{ url('/test/design-category') }}#radharani-radha" class="cat7-item">
          <h4>Radharani / Radha</h4>
          <span class="cat-explore">Explore Category <span>&rarr;</span></span>
        </a>
        <a href="{{ url('/test/design-category') }}#gopinath-krishna" class="cat7-item">
          <h4>Gopinath / Krishna</h4>
          <span class="cat-explore">Explore Category <span>&rarr;</span></span>
        </a>
        <a href="{{ url('/test/design-category') }}#vishakhadevi" class="cat7-item">
          <h4>Vishakhadevi</h4>
          <span class="cat-explore">Explore Category <span>&rarr;</span></span>
        </a>
        <a href="{{ url('/test/design-category') }}#gopalji" class="cat7-item">
          <h4>Gopalji</h4>
          <span class="cat-explore">Explore Category <span>&rarr;</span></span>
        </a>
      </div>
  ...
  <section class="section timeline-sec">
    <div class="container">
      ...
      <div class="timeline-cta">
        <a href="{{ url('/test/submit') }}" class="btn-gold">
          <span>Register Now</span>
          <span class="arrow">&rarr;</span>
        </a>
      </div>
    ...
    <div class="jury-slider-wrap">
      <div class="jury-slider-track">
        <div class="jury-slide">
          <div class="jury-slide-img"><img src="{{ asset('testdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%201_thumb.jpg') }}" alt="Priya Sharma"></div>
          <h4 class="jury-slide-name">Priya Sharma</h4>
          <span class="jury-slide-role">Master Jeweller &amp; Design Consultant</span>
        </div>
        <div class="jury-slide">
          <div class="jury-slide-img"><img src="{{ asset('testdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%202_thumb.jpg') }}" alt="Arjun Mehta"></div>
          <h4 class="jury-slide-name">Arjun Mehta</h4>
          <span class="jury-slide-role">Creative Director, Heritage Jewellery House</span>
        </div>
        <div class="jury-slide">
          <div class="jury-slide-img"><img src="{{ asset('testdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%206_thumb.jpg') }}" alt="Radhika Iyer"></div>
          <h4 class="jury-slide-name">Radhika Iyer</h4>
          <span class="jury-slide-role">Fine Jewellery Curator</span>
        </div>
        <div class="jury-slide">
          <div class="jury-slide-img"><img src="{{ asset('testdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%204_thumb.jpg') }}" alt="Vikram Nair"></div>
          <h4 class="jury-slide-name">Vikram Nair</h4>
          <span class="jury-slide-role">Gemologist &amp; Craft Historian</span>
        </div>
        <div class="jury-slide">
          <div class="jury-slide-img"><img src="{{ asset('testdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%205_thumb.jpg') }}" alt="Ananya Desai"></div>
        ...
        <div class="jury-slide" aria-hidden="true">
          <div class="jury-slide-img"><img src="{{ asset('testdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%201_thumb.jpg') }}" alt=""></div>
          <h4 class="jury-slide-name">Priya Sharma</h4>
          <span class="jury-slide-role">Master Jeweller &amp; Design Consultant</span>
        </div>
        <div class="jury-slide" aria-hidden="true">
          <div class="jury-slide-img"><img src="{{ asset('testdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%202_thumb.jpg') }}" alt=""></div>
          <h4 class="jury-slide-name">Arjun Mehta</h4>
          <span class="jury-slide-role">Creative Director, Heritage Jewellery House</span>
        </div>
        <div class="jury-slide" aria-hidden="true">
          <div class="jury-slide-img"><img src="{{ asset('testdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%206_thumb.jpg') }}" alt=""></div>
          <h4 class="jury-slide-name">Radhika Iyer</h4>
          <span class="jury-slide-role">Fine Jewellery Curator</span>
        </div>
        <div class="jury-slide" aria-hidden="true">
          <div class="jury-slide-img"><img src="{{ asset('testdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%204_thumb.jpg') }}" alt=""></div>
          <h4 class="jury-slide-name">Vikram Nair</h4>
          <span class="jury-slide-role">Gemologist &amp; Craft Historian</span>
        </div>
        <div class="jury-slide" aria-hidden="true">
          <div class="jury-slide-img"><img src="{{ asset('testdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%205_thumb.jpg') }}" alt=""></div>
          <h4 class="jury-slide-name">Ananya Desai</h4>
          <span class="jury-slide-role">Founder, Sacred Design Studio</span>
        </div>
      </div>
  ...
  <footer>
    <div class="footer-top">
      ...
      <div class="footer-col">
        <h5>Explore</h5>
        <ul>
          <li><a href="{{ url('/test/about') }}">About DDA</a></li>
          <li><a href="{{ url('/test/categories') }}">Categories</a></li>
          <li><a href="{{ url('/test/inspiration') }}">Inspiration</a></li>
          <li><a href="{{ url('/test/participate') }}#dates">Calendar</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h5>Participate</h5>
        <ul>
          <li><a href="{{ url('/test/participate') }}#how-to-enter">How to Enter</a></li>
          <li><a href="{{ url('/test/participate') }}#fees">Fees</a></li>
          <li><a href="{{ url('/test/participate') }}#guidelines">Guidelines</a></li>
          <li><a href="{{ url('/test/faq') }}">FAQ</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h5>Contact</h5>
