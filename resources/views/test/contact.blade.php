...
<body>
  ...
  <nav>
    ...
    <div class="nav-links">
      ...
      <a href="{{ url('/test/contact') }}" class="nav-link active">Contact</a>
    </div>
    <div class="nav-right">
  ...
  <div class="mobile-menu-drawer">
    ...
    <div class="mobile-menu-links">
      ...
      <a href="{{ url('/test/contact') }}" class="mob-link active">Contact</a>
...
<section
    ...
    style="background-image:url('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/contact+page.png');
