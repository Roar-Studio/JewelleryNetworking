                    ...
                    <div class="detail-modal-container rounded-0">
                        ...
                        <form id="addMembershipForm">
                            <div class="row">
                                ...
                                <div class="form-group mb-2 col-md-12">
                                    <label class="form-label required">Amount (in &#8377;)</label>
                                    <div class="input-group">
                                        <span class="input-group-text">&#8377;</span>
                                        <input type="text" class="form-control" name="amount_in_inr" placeholder="Enter Amount"/>
                                    </div>
                                </div>
                                <div class="form-group mb-2 col-md-12">
                                    <label class="form-label required">Amount (in $)</label>
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                        <input type="text" class="form-control" name="amount_in_usd" placeholder="Enter Amount"/>
                                    </div>
                                </div>
                                <div class="form-group mb-2 col-md-12">
