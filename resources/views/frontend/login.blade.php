            ...
            <div class="auth-inner">
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="/"><p class="text-left my-2"><i class="bi bi-chevron-left"></i> Go to Homepage</p></a>
                            </div>
                            <div class="col-6" align="right">
                                <a href="https://youtu.be/4_-eyFAmx-c?si=X7c1rRYH7kV0VAOI" target="_blank">
                                    <p class="text-right my-2">How to Signup  
