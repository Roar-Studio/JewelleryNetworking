...
<body>
    ...
    <div class="mobile-menu-drawer">
        <div class="mobile-menu-logo"><img src="{{ asset('deitiesdesignawardsdda/Logo/Logo_1_horizontal_color.svg') }}"
    ...
    <section class="section">
        <div class="container">
                ...
                <ol class="step-list">
                    <li>
                        ...
                        <div class="step-content">
                            <h4>Registration</h4>
                            <p>Create your participant account and confirm your chosen category. Provide your details as
                                a designer, brand, artisan or student.<br>Registration is free you only pay the
                                submission fee when you are ready to submit.</p>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="step-content">
                            ...
                            <p>Prepare your entry materials including high-resolution images (JPEG/PNG, minimum 2000px
                                on the long side), a design statement describing the piece&#x2019;s sacred intent and
                                supporting technical documentation. Review the submission guidelines carefully before
                                preparing your files.</p>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="step-content">
                            <h4>Submission</h4>
                            <p>Complete the online submission form. Upload your images, fill in all required fields, pay
                                the submission fee and confirm your declaration. You will receive a confirmation email
                                with your entry reference number.</p>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="step-content">
                            ...
                            <p>Your entry is reviewed through the DDA jury process, beginning with preliminary screening
                                for eligibility, compliance and concept review, followed by final jury evaluation for
                                design, execution and relevance. <a
                                    href="{{ url('/deitiesdesignawards/jury') }}#evaluation-criteria"
                                    style="color:var(--gold,#b8922a)">View the evaluation criteria</a>.</p>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="step-content">
                            ...
                            <p>Shortlisted and winning entries are announced at the Deities Design Awards Ceremony 2026.
                                Winners receive their trophy, citation and access to a dedicated winners&#x2019; gallery
                                platform with year-round visibility.</p>
                        </div>
                    </li>
                </ol>
                <a href="{{ route('dda.login') }}"
                    onclick="localStorage.setItem('redirectAfterLogin','{{ route('dda.submit') }}')" class="btn-gold"
                    style="display:inline-flex;align-items:center;gap:.75rem;margin-top:2.5rem"><span>Begin Your
                        Submission</span><span class="arrow">&#x2192;</span></a>
            </div>
            ...
            <div class="p-panel" id="tab-guidelines">
                ...
                <p>All entries must meet the following requirements to be considered for evaluation. <br>Submissions
                    that do not comply with these guidelines may be disqualified without refund.</p>
                <br>
                <ul class="guidelines-list">
                    <li><strong>Image format:</strong> JPEG or PNG only. No other formats accepted.</li>
                    <li><strong>Resolution:</strong> Minimum 2000 pixels on the long side. Recommended 3000px+. Images
                        must be sharp, well-lit and free of watermarks.</li>
                    <li><strong>File size:</strong> Maximum 25 MB per image. Maximum 10 images per submission entry.
                    </li>
                    <li><strong>Image content:</strong> Images must show only the submitted piece. No stock backgrounds,
                        props or models that distract from the jewellery are permitted.</li>
                    <li><strong>No AI-generated or enhanced images:</strong> AI-generated or AI-enhanced images are
                        strictly not allowed. Submitted images must be genuine, unedited-beyond-basic-correction
                        photographs of the actual physical piece.</li>
                    <li><strong>Multiple views:</strong> We recommend including at least 3 views front, detail/close-up
                        and a contextual or scale shot.</li>
                    <li><strong>Design statement:</strong> Required for all entries. Between 150 and 500 words
                        describing the sacred inspiration, design intent, materials and techniques used.</li>
                    <li><strong>Eligibility:</strong> Entries must represent work created within the past 3 years
                        (2023-2026). Previously submitted entries to DDA are not eligible for resubmission.</li>
                    <li><strong>Authenticity:</strong> All submitted work must be the original creation of the entrant.
                        Collaborative work must be clearly disclosed with all contributors named.</li>
                    <li><strong>Sacred intent:</strong> All entries must be jewellery created with explicit sacred,
                        devotional or spiritual intent for deities, temples, religious occasions or spiritual practices.
                    </li>
                    <li><strong>Language:</strong> All written submissions must be in English. Hindi submissions may
                        include an English translation.</li>
                </ul>
            </div>
                    ...
                    <table class="fees-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><span class="fee-inr">INR &#8377;2,500</span> <span class="fee-gst">(incl. GST)
                                        /</span> <span class="fee-usd">USD $29</span></td>
                                <td>Participants are eligible to submit up to 2 categories, Category 1 Radharani or
                                    Gopinath. <br><br>One entry in any of the other Deity categories, in accordance with
                                    the competition guidelines.</td>
                            </tr>
                            <tr>
                                <td>Special Category</td>
                                <td><span class="fee-inr">INR &#8377;9,000</span> <span class="fee-gst">(incl. GST)
                                        /</span> <span class="fee-usd">USD $99</span></td>
                                <td>Create 1 exclusive piece for any one deity</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <p style="font-size:.85rem;opacity:.75;margin-top:1rem">Part of the participation proceeds will be
                    donated to ISKCON Chowpatty.</p>
                <p style="font-size:.8rem;opacity:.6;font-style:italic">Fees are non-refundable unless mutually agreed
                    upon.</p>
            </div>
    ...
    <script>
        ...
        const tabs = document.querySelectorAll('.p-tab'),
            panels = document.querySelectorAll('.p-panel');
        tabs.forEach(tab => {
