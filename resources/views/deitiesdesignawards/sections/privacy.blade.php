...
<body>
    ...
    <nav>
        <a href="{{ url('/deitiesdesignawards/index') }}" class="nav-logo"><img
    ...
    <section class="section">
        <div class="container">
            <div class="legal-wrap">
                ...
                <p>Deities Design Awards (&#x201C;DDA&#x201D;, &#x201C;we&#x201D;, &#x201C;our&#x201D;) is committed to
                    protecting your privacy. This policy explains how we collect, use, store and protect your personal
                    information in connection with the awards platform and this website.</p>

                <h3>Information We Collect</h3>
                <p>We collect information you provide directly when you register, submit an entry, contact us or
                    subscribe to our communications. This includes your name, email address, phone number, city and
                    country organisation name and submission content including images and design statements. We also
                    collect standard website usage data including page views, browser type and referring URLs through
                    analytics tools.</p>

                <h3>How We Use Your Information</h3>
                <p>Your personal information is used to administer your entry and communicate with you about the awards
                    process, including confirmation emails, shortlist notifications and results announcements. We also
                    use your information to send you DDA updates and communications where you have opted in. Images and
                    creative content submitted as part of your entry may be used for DDA&#x2019;s editorial, promotional
                    and archival purposes as described in our Terms and Conditions.</p>

                <h3>Data Sharing</h3>
                <p>We do not sell your personal data. We do not share your information with third parties for marketing
                    purposes. We may share your information with jury members and evaluation partners solely for the
                    purpose of administering the awards. We may also share information with service providers who assist
                    in operating our platform, under strict confidentiality obligations.</p>

                <h3>Data Retention</h3>
                <p>We retain your personal information for as long as necessary to fulfil the purposes described in this
                    policy, including for legal, accounting and reporting obligations. Entry records and associated
                    images may be retained indefinitely for archival purposes with your consent as described in our
                    Terms and Conditions.</p>

                <h3>Your Rights</h3>
                <p>You have the right to access, correct or delete your personal information held by DDA. You may also
                    withdraw consent for marketing communications at any time. To exercise these rights, please contact
                    us at <a href="mailto:info@deitiesdesignawards.com"
                        style="color:var(--gold,#b8922a)">info@deitiesdesignawards.com</a>.</p>

                <h3>Cookies</h3>
                <p>This website uses essential cookies to enable core functionality. We use analytics cookies to
                    understand how visitors use our site and improve the user experience. You may disable cookies in
                    your browser settings, though this may affect website functionality. We do not use cookies for
                    targeted advertising.</p>

                <h3>Security</h3>
                <p>We implement reasonable technical and organisational measures to protect your personal information
                    against unauthorised access, disclosure, alteration or destruction. However, no internet
                    transmission is completely secure and we cannot guarantee the absolute security of your data.</p>

                <h3>GDPR Compliance</h3>
                <p>For participants in the European Economic Area, we process personal data on the basis of legitimate
                    interest (awards administration) and consent (marketing communications). You have the right to lodge
                    a complaint with your local data protection authority.</p>

                <h3>Refund Policy</h3>
                <p>Entry fees are non-refundable once a submission has entered preliminary screening. If a submission is
                    rejected before preliminary screening due to a technical error on DDA&#x2019;s part, a full refund
                    will be issued. All refund requests must be made within 30 days of submission by contacting <a
                        href="mailto:info@deitiesdesignawards.com"
                        style="color:var(--gold,#b8922a)">info@deitiesdesignawards.com</a>.</p>

                <h3>Changes to This Policy</h3>
                <p>We may update this privacy policy from time to time. Material changes will be communicated to
                    registered participants via email. Continued use of the website or the submission platform after
                    changes have been made constitutes acceptance of the updated policy.</p>

                <div class="legal-contact-note">
                    <p>Privacy enquiries: <a
