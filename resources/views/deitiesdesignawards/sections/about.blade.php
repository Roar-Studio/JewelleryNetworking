...
<body>
    ...
    <div class="announce">Inaugural Edition | 2026 <span class="pipe">|</span> Registration opens soon <span
            class="pipe">|</span> <a href="{{ url('/deitiesdesignawards/contact') }}">Be notified &rarr;</a></div>
    <nav>
    ...
    <section class="section"
        style="display:none;background:rgba(184,146,42,.04);border-top:1px solid rgba(184,146,42,.12);border-bottom:1px solid rgba(184,146,42,.12)">
        <div class="container">
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="founder-bio-grid">
                <div>
                    <img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/founder.webp') }}"
                        alt="Prernaa Makhariaa" class="founder-profile-photo"
                        style="width:100%;aspect-ratio:4/5;object-fit:cover;border:1px solid rgba(184,146,42,.2);display:block">
                    <div class="founder-bio-meta"
                        style="margin-top:1.5rem;padding-top:1.25rem;border-top:1px solid rgba(184,146,42,.2)">
                        <span class="founder-bio-name"
                            style="display:block;font-family:var(--serif);font-size:1.4rem;font-style:italic;margin-bottom:.2rem">Prernaa
                            Makhariaa</span>
                        <span class="founder-bio-role"
                            style="display:block;font-family:var(--body);font-size:.82rem;letter-spacing:.12em;text-transform:uppercase;color:var(--gold-deep,#8a7026);line-height:1.6">Founder
                            &amp; Visionary,<br>Deities Design Awards (DDA).</span>
                    </div>
                </div>
                <div>
                    <blockquote
                        style="font-family:var(--serif);font-size:1.5rem;font-style:italic;font-weight:300;line-height:1.65;border-left:2px solid var(--gold,#b8922a);padding-left:1.5rem;margin:0 0 2rem">
                        &#x201C;BE CEEN: Connect, Engage, Empower and Network.&#x201D;
                    </blockquote>
                    <p>
                        Prernaa Makhariaa, Founder &amp; Visionary of the Deities Design Awards (DDA), is a jewellery
                        entrepreneur and industry influencer with over two decades of experience.
                    </p>
                    <br>
                    <p>
                        She is also the founder of Jewellery Networking, a global platform built on the philosophy of
                        <strong>&#x201C;BE CEEN: Connect, Engage, Empower and Network.&#x201D;</strong>
                    </p>
                    <br>
                    <p>
                        The platform serves as a one-stop destination for the jewellery community, bringing together
                        businesses, service providers, and industry professionals to foster collaboration, growth,
                        learning, innovation, and meaningful connections across the global gems and jewellery ecosystem.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="section"
        style="background:rgba(184,146,42,.04);border-top:1px solid rgba(184,146,42,.12);border-bottom:1px solid rgba(184,146,42,.12)">
        <div class="container">
            <div style="text-align:center;margin-bottom:3rem">
            ...
            <div class="vision-split">
                <div class="vision-card">
                    ...
                    <p>The Deities Design Awards is a globally travelling initiative dedicated to honouring exceptional
                        jewellery design and craftsmanship. Hosted at a different spiritual destination each year,
                        through this platform we aim to give back to society by encouraging jewellery that carries
                        purpose, tells stories and upholds the finest traditions of craftsmanship and innovation for
                        future generations.</p>
                </div>
                <div class="vision-card">
                    <span class="vision-card-label">Vision Statement</span>
                    <p>To cultivate a worldwide legacy that honors and promotes jewellery rooted in faith, tradition and
                        heritage. By uniting unparalleled creative voices from across the globe, the platform aims to
                        exhibit artistic excellence, safeguard cultural histories and advocate for craftsmanship as an
                        enduring manifestation of human ingenuity.</p>
                </div>
            </div>
    ...
    <!-- <section class="about-deep-grid section">
    ...
    <footer>
        ...
        <div class="footer-bottom">
            ...
            <span><a href="{{ url('/deitiesdesignawards/terms') }}">Terms</a><a
                    href="{{ url('/deitiesdesignawards/privacy') }}">Privacy</a><a
                    href="{{ url('/deitiesdesignawards/terms') }}">Code of Conduct</a></span>
        </div>
    </footer>
    <script>
