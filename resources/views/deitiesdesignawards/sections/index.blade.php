...
<body>
    ...
    <!--  NAV  -->
    <nav>
        <a href="#" class="nav-logo"><img src="{{ asset('dda-assets/images/Logo_1_horizontal_color.svg') }}"
    ...
    <section class="hero">
        <div class="hero-media">
            <img class="hero-banner-img"
                src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/Homepage.png') }}"
        ...
        <div class="hero-content">
            ...
            <div class="hero-cta-row">
                <a href="{{ route('dda.login') }}" class="btn-gold pulse"
                    onclick="localStorage.setItem('redirectAfterLogin','{{ route('dda.submit') }}')">
    ...
    <section class="section categories">
        <div class="container">
            ...
            <div class="cat-strip" aria-hidden="true">
                <img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/Nitai.jpg') }}"
                    alt="">
                <img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/Gaur.jpg') }}"
                    alt="">
                <img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/Lalita.jpg') }}"
                    alt="">
                <img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/Radha.jpg') }}"
                    alt="">
                <img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/Krishna.jpg') }}"
                    alt="">
                <img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/Vishaka+Devi.jpg') }}"
                    alt="">
                <img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/Gopalji.jpg') }}"
                    alt="">
            </div>
        ...
        <div class="container" style="text-align:center">
            ...
            <div class="inspo-banner">
                <a href="{{ url('/deitiesdesignawards/gallery') }}?category=carvings" class="inspo-panel">
                    <div class="inspo-panel-img"><img
                            src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/CARVINGS.png') }}"
                            alt="Carvings" loading="lazy"></div>
                ...
                <a href="{{ url('/deitiesdesignawards/gallery') }}?category=paintings" class="inspo-panel">
                    <div class="inspo-panel-img"><img
                            src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/PAINTINGS+(1).png') }}"
                            alt="Painting" loading="lazy"></div>
                ...
                <a href="{{ url('/deitiesdesignawards/gallery') }}?category=wooden" class="inspo-panel">
                    <div class="inspo-panel-img"><img
                            src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/WOODEN+(1).png') }}"
                            alt="Wooden" loading="lazy"></div>
                ...
                <a href="{{ url('/deitiesdesignawards/gallery') }}?category=deities" class="inspo-panel">
                    <div class="inspo-panel-img"><img
                            src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/DIETY+INSPO+(1).png') }}"
                            alt="Deities" loading="lazy"></div>
    ...
    <section class="section timeline-sec">
        <div class="container">
            ...
            <div class="timeline-cta">
                <a href="{{ route('dda.login') }}" class="btn-gold"
                    onclick="localStorage.setItem('redirectAfterLogin','{{ route('dda.submit') }}')">
                    <span>Register Now</span>
                    <span class="arrow">&rarr;</span>
                </a>
        ...
        <div class="jury-slider-wrap">
            <div class="jury-slider-track">
                <div class="jury-slide">
                    <div class="jury-slide-img"><img
                            src="{{ asset('deitiesdesignawardsdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%201_thumb.jpg') }}"
                            alt="Priya Sharma"></div>
                    <h4 class="jury-slide-name">Priya Sharma</h4>
                    <span class="jury-slide-role">Master Jeweller &amp; Design Consultant</span>
                </div>
                <div class="jury-slide">
                    <div class="jury-slide-img"><img
                            src="{{ asset('deitiesdesignawardsdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%202_thumb.jpg') }}"
                            alt="Arjun Mehta"></div>
                ...
                <div class="jury-slide">
                    <div class="jury-slide-img"><img
                            src="{{ asset('deitiesdesignawardsdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%206_thumb.jpg') }}"
                            alt="Radhika Iyer"></div>
                    <h4 class="jury-slide-name">Radhika Iyer</h4>
                    <span class="jury-slide-role">Fine Jewellery Curator</span>
                </div>
                <div class="jury-slide">
                    <div class="jury-slide-img"><img
                            src="{{ asset('deitiesdesignawardsdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%204_thumb.jpg') }}"
                            alt="Vikram Nair"></div>
                ...
                <div class="jury-slide">
                    <div class="jury-slide-img"><img
                            src="{{ asset('deitiesdesignawardsdda/inspiration%20pdf%20and%20images/Painting/thumbs/Painting%205_thumb.jpg') }}"
                            alt="Ananya Desai"></div>
    ...
    <script>
        ...
        document.addEventListener('click', (e) => {
            if (!drawer.contains(e.target) && !toggleBtn.contains(e.target) && drawer.classList.contains(
                    'active')) {
