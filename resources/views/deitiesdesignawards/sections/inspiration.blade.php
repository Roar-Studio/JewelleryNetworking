  ...
  <section class="section insp-banner-sec">
    <div class="container">
      ...
      <div class="insp-row-full">
        <img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/COLOR+PALETTE+1.png') }}" alt="Inspiration collection" loading="lazy">
      ...
      <div class="insp-grid2">
        <div class="insp-item">
          <div class="insp-tile"><img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/CARVINGS.png') }}" alt="Carvings" loading="lazy"></div>
          <div class="insp-btncell">
            <button class="insp-btn insp-btn-gallery" onclick="openGallery('carvings')">Open Carving Gallery</button>
          </div>
        </div>
        <div class="insp-item">
          <div class="insp-tile"><img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/PAINTINGS+(1).png') }}" alt="Painting" loading="lazy"></div>
          <div class="insp-btncell">
            <button class="insp-btn insp-btn-gallery" onclick="openGallery('paintings')">Open Painting Gallery</button>
          </div>
        </div>
        <div class="insp-item">
          <div class="insp-tile"><img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/WOODEN+(1).png') }}" alt="Wooden" loading="lazy"></div>
          <div class="insp-btncell">
            <button class="insp-btn insp-btn-gallery" onclick="openGallery('wooden')">Open Wooden Gallery</button>
          </div>
        </div>
        <div class="insp-item">
          <div class="insp-tile"><img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/DIETY+INSPO+(1).png') }}" alt="Deities" loading="lazy"></div>
          <div class="insp-btncell">
