...
<body>
    ...
    <nav>
        ...
        <div class="nav-links">
            ...
            <a href="{{ url('/deitiesdesignawards/inspiration') }}" class="nav-link active">Inspiration</a>
            <div class="has-dropdown">
    ...
    <section class="section insp-banner-sec">
        <div class="container">
            ...
            <div class="insp-row-full">
                <img src="{{ asset('https://deities-design-awards-assets.s3.ap-south-1.amazonaws.com/DDA+Web+Images/COLOR+PALETTE+1.png') }}"
                    alt="Inspiration collection" loading="lazy">
            ...
            <div class="insp-grid2">
                <div class="insp-item">
                    ...
                    <div class="insp-btncell">
                        <button class="insp-btn insp-btn-gallery" onclick="openGallery('carvings')">Open Carving
                            Gallery</button>
                    </div>
                </div>
                <div class="insp-item">
                    ...
                    <div class="insp-btncell">
                        <button class="insp-btn insp-btn-gallery" onclick="openGallery('paintings')">Open Painting
                            Gallery</button>
                    </div>
                </div>
                <div class="insp-item">
                    ...
                    <div class="insp-btncell">
                        <button class="insp-btn insp-btn-gallery" onclick="openGallery('wooden')">Open Wooden
                            Gallery</button>
                    </div>
                </div>
                <div class="insp-item">
                    ...
                    <div class="insp-btncell">
                        <button class="insp-btn insp-btn-gallery" onclick="openGallery('deities')">Open Deities
                            Gallery</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function openGallery(type) {
            window.location.href = `{{ url('/deitiesdesignawards/gallery') }}?category=${type}`;
        }
    </script>
</body>
