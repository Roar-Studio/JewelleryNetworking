...
<body>
        ...
        <div class="container">
            ...
            <div style="text-align:center;margin-bottom:3rem">
                <p style="max-width:740px;margin:1rem auto 0;font-size:.9rem;opacity:.7;line-height:1.8">
                    DDA offers a unique opportunity to align your brand with devotion, heritage and creative
                    excellence.<br>
            ...
            <div class="sponsor-grid">
                ...
                <div class="sponsor-tier-card">
                    ...
                    <div class="sponsor-card-actions">
                        <button type="button" class="sponsor-read-more" data-sponsor="title-sponsor">
                            Read More
                        </button>
                ...
                <div class="sponsor-tier-card">
                    ...
                    <div class="sponsor-card-actions">
                        <button type="button" class="sponsor-read-more" data-sponsor="powered-by">
                            Read More
                        </button>
                ...
                <div class="sponsor-tier-card">
                    ...
                    <div class="sponsor-card-actions">
                        <button type="button" class="sponsor-read-more" data-sponsor="logistics-partner">
                            Read More
                        </button>
            ...
            <p style="text-align:center;margin-top:1.5rem;font-size:.85rem;opacity:.6">
                ...
                <a href="mailto:info@deitiesdesignawards.com" style="color:var(--gold-deep,#8a7026)">
                    info@deitiesdesignawards.com
                </a>
                or call
                <a href="tel:+919819155544" style="color:var(--gold-deep,#8a7026)">
                    +91 98191 55544
                </a>
            </p>
        ...
        <div class="container">
            ...
            <div class="sponsor-grid">
                <div class="sponsor-tier-card">
                    ...
                    <div class="sponsor-card-actions">
                        <button type="button" class="sponsor-read-more" data-sponsor="accessories-sponsor">Read
                            More</button>
                        <a href="{{ url('/deitiesdesignawards/contact') }}"
                            class="btn-gold"><span>Enquire</span><span class="arrow">→</span></a>
                    </div>
                </div>
                <div class="sponsor-tier-card">
                    ...
                    <div class="sponsor-card-actions">
                        <button type="button" class="sponsor-read-more" data-sponsor="accessories-co-sponsor">Read
                            More</button>
                        <a href="{{ url('/deitiesdesignawards/contact') }}"
                            class="btn-gold"><span>Enquire</span><span class="arrow">→</span></a>
                    </div>
                ...
                <div class="sponsor-tier-card">
                    ...
                    <div class="sponsor-card-actions">
                        <button type="button" class="sponsor-read-more" data-sponsor="necklace-set">Read
                            More</button>
                        <a href="{{ url('/deitiesdesignawards/contact') }}"
                            class="btn-gold"><span>Enquire</span><span class="arrow">→</span></a>
                    </div>
            ...
            <div class="sponsor-grid" style="margin-top:2rem">
                ...
                <div class="sponsor-tier-card">
                    ...
                    <h4>INR &#8377;6 Lakh + GST</h4>
                    <div class="sponsor-card-actions">
                        <button type="button" class="sponsor-read-more" data-sponsor="bangle-bracelet">Read
                            More</button>
                        <a href="{{ url('/deitiesdesignawards/contact') }}"
                            class="btn-gold"><span>Enquire</span><span class="arrow">→</span></a>
                    </div>
          ...
          <div class="sponsor-card-actions">
            ...
            <a href="{{ url('/deitiesdesignawards/contact') }}" class="btn-gold"><span>Enquire</span><span class="arrow">→</span></a>
                ...
                <div class="sponsor-tier-card">
                    ...
                    <h4>INR &#8377;5 Lakh + GST</h4>
                    <div class="sponsor-card-actions">
                        <button type="button" class="sponsor-read-more" data-sponsor="special-category">Read
                            More</button>
                        <a href="{{ url('/deitiesdesignawards/contact') }}"
                            class="btn-gold"><span>Enquire</span><span class="arrow">→</span></a>
                    </div>
            ...
            <p style="text-align:center;margin-top:1.5rem;font-size:.85rem;opacity:.6">For more details, mail us at <a
                    href="mailto:info@deitiesdesignawards.com"
                    style="color:var(--gold-deep,#8a7026)">info@deitiesdesignawards.com</a> or call <a
                    href="tel:+919819155544" style="color:var(--gold-deep,#8a7026)">+91 98191 55544</a></p>
        </div>
    </section>
    ...
    <div class="sponsor-modal-overlay" id="sponsorModalOverlay">
        <div class="sponsor-modal" role="dialog" aria-modal="true" aria-labelledby="sponsorModalTitle">
            <button type="button" class="sponsor-modal-close" id="sponsorModalClose"
