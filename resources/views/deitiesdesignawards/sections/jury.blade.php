...
<body>
  ...
  <nav>
    <a href="{{ url('/deitiesdesignawards') }}" class="nav-logo"><img src="{{ asset('dda-assets/images/Logo_1_horizontal_color.svg') }}"
...
<section class="page-hero-int wash-gold"
  ...
  <section class="cta-strip">
    ...
    <div class="cta-inner">
      ...
      <a href="{{ url('/deitiesdesignawards/submit') }}" class="btn-cta-gold"><span>Submit Your Entry</span><span class="arrow">&#x2192;</span></a>
    </div>
  </section>
