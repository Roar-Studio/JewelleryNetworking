...
<body>
    ...
    <section class="section jury-criteria-section" id="evaluation-criteria">
        <div class="container jury-criteria-layout">
            ...
            <div class="jury-criteria-list">
                <div><span>01</span>
                    <h3>Concept &amp; Interpretation</h3>
                </div>
                <div><span>02</span>
                    <h3>Relevance to Theme</h3>
                </div>
                <div><span>03</span>
                    <h3>Craft Feasibility</h3>
                </div>
                <div><span>04</span>
                    <h3>Design Quality</h3>
                </div>
                <div><span>05</span>
                    <h3>Material Understanding</h3>
                </div>
                <div><span>06</span>
            ...
            <div class="jury-policy-list">
                <article><span>01</span>
                    <div>
                        ...
                        <p>Jury members must disclose any association with participants. Entries will be reassigned
                            where required.</p>
                    </div>
                </article>
    ...
    <section class="cta-strip">
        ...
        <div class="cta-inner">
            ...
            <a href="{{ url('/deitiesdesignawards/submit') }}" class="btn-cta-gold"><span>Submit Your
                    Entry</span><span class="arrow">&#x2192;</span></a>
        </div>
    </section>
