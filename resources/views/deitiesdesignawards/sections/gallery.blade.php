...
<body>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="deity-filter-tabs gallery-filter-tabs" id="deity-filter-tabs" aria-label="Filter deities">

                <button class="gallery-tab-btn deity-tab-btn active" data-deity="all">
                    All Deities
                </button>

                <button class="gallery-tab-btn deity-tab-btn" data-deity="nitai">
                    Nitai
                </button>

                <button class="gallery-tab-btn deity-tab-btn" data-deity="gaur">
                    Gaur
                </button>

                <button class="gallery-tab-btn deity-tab-btn" data-deity="lalita">
                    Lalita
                </button>

                <button class="gallery-tab-btn deity-tab-btn" data-deity="radha">
                    Radharani / Radha
                </button>

                <button class="gallery-tab-btn deity-tab-btn" data-deity="gopinath">
                    Gopinath / Krishna
                </button>

                <button class="gallery-tab-btn deity-tab-btn" data-deity="vishakhadevi">
                    Vishakhadevi
                </button>

                <button class="gallery-tab-btn deity-tab-btn" data-deity="gopalji">
                    Gopalji
                </button>
...
">
    ...
    <div class="lightbox" id="lightbox">
        <a class="lightbox-download" id="lightbox-download" href="#" download
            onclick="downloadImage(event)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                stroke-width="1.8">
                <path d="M12 3v12M7 10l5 5 5-5M5 21h14" />
            </svg>Download</a>
    ...
    <script
        src="{{ asset('dda-assets/js/gallery-data.js') }}?v={{ filemtime(public_path('dda-assets/js/gallery-data.js')) }}">
    </script>
    <script>
