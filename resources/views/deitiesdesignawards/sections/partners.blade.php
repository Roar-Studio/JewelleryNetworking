...
<section class="page-hero-int wash-gold"
    ...
    <div class="container">
      ...
      <div class="partner-full">
        ...
        <div class="partner-full-content">
          ...
          <p>It will be supported by <b>The Jewellers Association Bengaluru</b>, serving as the official industry partner for the Deities Design Awards (DDA). The Jewellers Association Bengaluru is instrumental in driving sectoral involvement and commitment. Utilizing its broad professional network, the association bridges the gap between the awards and prominent jewellers, producers, craftsmen and major industry figures, encouraging cooperative efforts and guaranteeing robust representation across the field.</p>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="partner-full">
        ...
        <div class="partner-full-content">
          ...
          <h4 class="partner-copy-label">Role in DDA</h4>
          <p>This prestigious project is the brainchild, ideated and conceptualized by <b>Prernaa Makhariaa of Jewellery Networking</b>, with Jewellery Networking serving as the founding and organizing force behind the Deities Design Awards and the conceptual heart of the initiative. By aligning its mission to build global connections with the DDA's focus on celebrating devotion through design, this project—which is one of the most important, special and close to my heart unites spiritual institutions, industry leaders and creative participants. It ensures the awards achieve an international reach, creating a lasting legacy through cultural exchange, professional recognition and impactful collaborations.</p>
          <a href="https://jewellerynetworking.com/" target="_blank" rel="noopener" class="story-link" style="display:inline-flex;margin-top:.75rem">Visit Jewellery Networking <span>→</span></a>
        </div>
      </div>
  </section>
  ...
  <section class="cta-strip">
    ...
    <div class="cta-inner">
      ...
      <a href="{{ url('/deitiesdesignawards/sponsor-us') }}" class="btn-cta-gold"><span>Sponsorship Options</span><span class="arrow">→</span></a>
    </div>
  </section>
  <footer>
