      ...
      <div class="submit-layout">
        ...
        <aside class="submit-progress">
          ...
          <ul class="progress-steps">
            ...
            <li class="prog-step" data-step="2"><span class="prog-num">2</span><span class="prog-label">Deity Category Entries</span></li>
            <li class="prog-step" data-step="3"><span class="prog-num">3</span><span class="prog-label">Declaration</span></li>
          </ul>
          <div class="submit-sidebar-note">
            ...
            <p style="margin-top:.75rem"><a href="{{ url('/deitiesdesignawards/participate') }}#guidelines" style="color:var(--gold,#b8922a);font-size:.8rem">View submission guidelines &#x2192;</a></p>
          </div>
        </aside>
            ...
            <div class="sub-panel active" id="sub-panel-1">
              ...
              <div class="form-grid">
                <div class="form-field">
                  ...
                  <input type="text" id="f-first" name="first_name" value="{{ old('first_name') }}" placeholder="Your first name" required>
                  @error('first_name')
                ...
                <div class="form-field">
                  ...
                  <input type="text" id="f-last" name="last_name" value="{{ old('last_name') }}" placeholder="Your last name" required>
                  @error('last_name')
                    <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
                <div class="form-field full">
                  ...
                  <input type="email" id="f-email" name="email" value="{{ old('email') }}" placeholder="your@email.com" required>
                  @error('email')
                    <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
                <div class="form-field">
                  ...
                  <input type="tel" id="f-phone" name="phone" value="{{ old('phone') }}" placeholder="+91 XXXXX XXXXX">
                  @error('phone')
                    <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
                <div class="form-field">
                  ...
                  <input type="text" id="f-city" name="city" value="{{ old('city') }}" placeholder="Mumbai" required>
                  @error('city')
                    <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="form-field full">
                  ...
                  <input type="text" id="f-org" name="organisation" value="{{ old('organisation') }}" placeholder="Your brand or studio (if applicable)">
                  @error('organisation')
                    <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
...
<div
    ...
    @enderror
            ...
            <div class="sub-panel" id="sub-panel-2">
              ...
              <p class="sub-panel-desc">You may enter up to <strong>two Deity Categories</strong>: one from Radharani&#8202;/&#8202;Radha or Gopinath&#8202;/&#8202;Krishna, and one from Nitai, Gaur, Lalita, Vishakhadevi or Gopalji. For each, select the deity, the jewellery piece from that deity&#8217;s category, describe your piece and upload your images.</p>
                ...
                <div class="form-grid">
                  <div class="form-field full">
                    ...
                    <select id="f-deity-a" name="deity_category_a" class="deity-select" required>
                      ...
                      <option value="radharani-radha" {{ old('deity_category_a') == 'radharani-radha' ? 'selected' : '' }}>Radharani / Radha</option>
                      <option value="gopinath-krishna" {{ old('deity_category_a') == 'gopinath-krishna' ? 'selected' : '' }}>Gopinath / Krishna</option>
                    </select>
                  ...
                  <div class="form-field full">
                    ...
                    <select id="f-piece-a" name="jewellery_piece_a" class="piece-select" required disabled data-old="{{ old('jewellery_piece_a') }}">
                  ...
                  <div class="form-field full">
                    <label for="f-statement-a">Design Statement <span class="req">*</span> <span class="field-note">(150&#x2013;500 words)</span></label>
                    <textarea id="f-statement-a" name="statement_a" rows="6" class="stmt-input" placeholder="Describe the sacred inspiration behind your piece, the design intent, the materials and techniques used and its connection to devotion or heritage..." required minlength="150">{{ old('statement_a') }}</textarea>
    ...
    <strong>Note:</strong> All submitted images must be photographed or presented against a plain <strong>white or black background only</strong>. Images with coloured, textured, or distracting backgrounds may not be considered during the evaluation process.
                ...
                <div class="upload-zone" id="upload-zone-a">
                  ...
                  <div class="upload-zone-inner">
                    ...
                    <p class="upload-secondary">or <button type="button" class="upload-browse" onclick="document.getElementById('file-input-a').click()">browse files</button></p>
                    <p class="upload-hint">JPEG or PNG &bull; Max 25 MB each &bull; Up to 10 images</p>
                  </div>
                </div>
                <div class="upload-count" id="upload-count-a" style="display:none"><span class="count-num">0</span> image(s) selected</div>
                ...
                <div class="form-grid">
                  <div class="form-field full">
                    ...
                    <select id="f-deity-b" name="deity_category_b" class="deity-select" required>
                      <option value="">Select deity category</option>
                      <option value="nitai" {{ old('deity_category_b') == 'nitai' ? 'selected' : '' }}>Nitai</option>
                      <option value="gaur" {{ old('deity_category_b') == 'gaur' ? 'selected' : '' }}>Gaur</option>
                      <option value="lalita" {{ old('deity_category_b') == 'lalita' ? 'selected' : '' }}>Lalita</option>
                      <option value="vishakhadevi" {{ old('deity_category_b') == 'vishakhadevi' ? 'selected' : '' }}>Vishakhadevi</option>
                      <option value="gopalji" {{ old('deity_category_b') == 'gopalji' ? 'selected' : '' }}>Gopalji</option>
                    </select>
                  ...
                  <div class="form-field full">
                    ...
                    <select id="f-piece-b" name="jewellery_piece_b" class="piece-select" required disabled data-old="{{ old('jewellery_piece_b') }}">
                      <option value="">Select deity category first</option>
                    </select>
                  ...
                  <div class="form-field full">
                    <label for="f-material-b">Primary Material <span class="req">*</span></label>
                    <input type="text" id="f-material-b" name="material_b" value="{{ old('material_b') }}" placeholder="e.g. 22k gold, rubies, enamel" required>
                    @error('material_b')
                      <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  <div class="form-field full">
                    <label for="f-statement-b">Design Statement <span class="req">*</span> <span class="field-note">(150&#x2013;500 words)</span></label>
                    <textarea id="f-statement-b" name="statement_b" rows="6" class="stmt-input" placeholder="Describe the sacred inspiration behind your piece, the design intent, the materials and techniques used and its connection to devotion or heritage..." required minlength="150">{{ old('statement_b') }}</textarea>
                    <div class="char-count"><span class="stmt-count">0</span> / 500 words</div>
                    @error('statement_b')
                      <div class="text-danger">{{ $message }}</div>
                    @enderror
    ...
    <strong>Note:</strong> All submitted images must be photographed or presented against a plain <strong>white or black background only</strong>. Images with coloured, textured, or distracting backgrounds may not be considered during the evaluation process.
                ...
                <div class="upload-zone" id="upload-zone-b">
                  ...
                  <div class="upload-zone-inner">
                    ...
                    <p class="upload-primary">Drag &amp; drop your images here</p>
                    <p class="upload-secondary">or <button type="button" class="upload-browse" onclick="document.getElementById('file-input-b').click()">browse files</button></p>
                    <p class="upload-hint">JPEG or PNG &bull; Max 25 MB each &bull; Up to 10 images</p>
                  </div>
                </div>
                <div class="upload-count" id="upload-count-b" style="display:none"><span class="count-num">0</span> image(s) selected</div>
              ...
              <div class="form-actions">
                ...
                <button type="button" class="btn-form-next" onclick="if(validateStep(2)) goStep(3)">Continue to Declaration <span>&#x2192;</span></button>
              </div>
            </div>
            ...
            <div class="sub-panel" id="sub-panel-3">
              ...
              <div class="declaration-block">
                <p>I confirm that the submitted work is my original creation and I hold the rights to enter it in this competition.</p>
                <p>I confirm that the submitted piece was created with sincere devotional, sacred or spiritual intent.</p>
                <p>I confirm that all information provided in this submission is accurate and complete.</p>
                <p>I grant Deities Design Awards the right to use submitted images for promotional, editorial and archival purposes with attribution.</p>
                <div class="check-row">
                  <input type="checkbox" id="declaration" name="declaration" value="1" required {{ old('declaration') ? 'checked' : '' }}>
                  <label for="declaration">I confirm and agree to all of the above declarations, and I have read and agree to the <a href="{{ url('/deitiesdesignawards/terms') }}" target="_blank" style="color:var(--gold,#b8922a)">Terms &amp; Conditions</a> and <a href="{{ url('/deitiesdesignawards/privacy') }}" target="_blank" style="color:var(--gold,#b8922a)">Privacy Policy</a>.</label>
                </div>
                @error('declaration')
                  <div class="text-danger">{{ $message }}</div>
                @enderror
  ...
  <script>
    ...
    const JEWELLERY_PIECES = {
      'nitai': ['Jhumka Earrings','Choker','Necklace 1','Necklace 2','Bracelet','Bangle','Waistbelt','Payal'],
      'gaur': ['Jhumka Earrings','Long Earrings','Choker','Necklace 1','Necklace 2','Bracelet','Bangle','Waistbelt','Payal'],
      'lalita': ['Paisley','Maangtikha','Damini / Mathapatti','Earrings','Nosering','Bangle','Choker','Necklace 1','Necklace 2','Necklace 3','Waistbelt','Payal','Rings'],
      'radharani-radha': ['Paisley','Damini / Mathapatti','Choker','Necklace 1','Necklace 2','Necklace 3','Waistbelt with Long Latkan','Bangle','Bracelet','Payal','Rings','Jhumka Earrings'],
      'gopinath-krishna': ['Long Earrings','Choker','Mala','Waistbelt','Payal','Bracelet','Flute'],
      'vishakhadevi': ['Paisley','Maangtikha','Damini / Mathapatti','Long Earrings','Nosering','Bangle','Choker','Necklace 1','Necklace 2','Necklace 3','Waistbelt','Payal','Rings'],
      'gopalji': ['Choker','Necklace 1','Necklace 2','Necklace 3','Necklace 4','Waistbelt','Bracelet 1','Bracelet 2','Payal','Stick']
    };
    ...
    const entryFiles = {};
    ['a','b'].forEach(key=>{
      const zone=document.getElementById('upload-zone-'+key), fi=document.getElementById('file-input-'+key);
      const grid=document.getElementById('preview-grid-'+key), countEl=document.getElementById('upload-count-'+key);
      const cntNum=countEl.querySelector('.count-num'), errEl=document.getElementById('upload-error-'+key);
      entryFiles[key]=[];
      ...
      function validateAndPreview(newFiles){
        ...
        if(list.length+valid.length>10){errs.push('Maximum 10 images allowed.');valid.splice(0,Math.max(0,list.length+valid.length-10));}
      ...
      grid.addEventListener('click',e=>{
        if(e.target.classList.contains('preview-remove')){
          entryFiles[key].splice(parseInt(e.target.dataset.idx),1);renderPreviews();syncFileInput();
        }
      });
      ...
      fi.addEventListener('change',()=>{validateAndPreview(fi.files);});
    });
    ...
    document.querySelectorAll('.stmt-input').forEach(ta=>{
      ...
      const updateCount=()=>{const w=ta.value.trim().split(/\s+/).filter(Boolean).length;wc.textContent=w;};
