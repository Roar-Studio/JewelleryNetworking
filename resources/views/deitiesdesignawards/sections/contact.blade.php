            ...
            <div class="contact-layout">
                <div class="contact-info">
                    ...
                    <div class="contact-detail-item">
                        <span class="cdi-icon"><svg width="18" height="18" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="1.5">
                                <path
                                    d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.22 2 2 0 0 1 3.6 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.64a16 16 0 0 0 6 6l1.27-.94a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
                            </svg></span>
                        <div><span class="cdi-label">Phone</span><a href="tel:+919819155544" class="cdi-value">+91
                                98191 55544</a></div>
                    </div>
                    ...
                    <div class="contact-detail-item">
                        ...
                        <div><span class="cdi-label">Email</span><a href="mailto:info@deitiesdesignawards.com"
                                class="cdi-value">info@deitiesdesignawards.com</a></div>
                    </div>
                    ...
                    <div class="contact-detail-item" style="margin-top:1.5rem">
                        ...
                        <div>
                            ...
                            <span class="cdi-value">B4 Parekh Market,<br>Basement Floor,<br>Next to Kennedy
                                Bridge,<br>Opera House,<br>Charni Road,<br>Mumbai- 400004.</span>
                            ...
                            <a href="https://www.google.com/maps/search/?api=1&query=B4+Parekh+Market+Basement+Floor+Next+to+Kennedy+Bridge+Opera+House+Charni+Road+Mumbai+400004"
                                target="_blank" rel="noopener" class="btn-outline contact-mini-map-btn">
                    ...
                    <div class="contact-detail-item">
                        ...
                        <div><span class="cdi-label">Office Hours</span><span class="cdi-value">10:00 AM &#x2013; 6:00
                                PM IST</span></div>
                    </div>
                </div>
                ...
                <div class="contact-form-col">
                    <div class="contact-form-card">
                        <h3 style="font-family:var(--serif);font-style:italic;font-size:1.5rem;margin-bottom:1.5rem">
                            Send us a message</h3>

                        @if (session('success'))
                            <div
                                style="padding:15px;background:#e8f8e8;border:1px solid #28a745;color:#155724;margin-bottom:20px;border-radius:6px;">
                                {{ session('success') }}
                            </div>
                        @endif
                        ...
                        @if ($errors->any())
                            <div
                                style="padding:15px;background:#fdeaea;border:1px solid #dc3545;color:#721c24;margin-bottom:20px;border-radius:6px;">
                        ...
                        <form class="contact-form" id="contact-form" method="POST"
                            ...
                            <div class="form-field">
                                ...
                                <textarea id="cf-msg" name="message" rows="6" placeholder="How can we help you?" required>{{ old('message') }}</textarea>
                            </div>
                            <button type="submit" class="btn-gold" style="width:100%;justify-content:center">Send
                                Message <span class="arrow">&#x2192;</span></button>
                            <div id="cf-success"
                                style="display:none;margin-top:1rem;padding:1rem;background:rgba(184,146,42,.08);border:1px solid rgba(184,146,42,.2);border-radius:4px;font-size:.85rem;text-align:center">
                                Thank you &#x2014; we&#x2019;ve received your message and will respond within 2 business
                                days.</div>
                        </form>
                    </div>
                </div>
