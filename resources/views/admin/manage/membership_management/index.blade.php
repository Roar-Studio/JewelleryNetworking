...
<div class="app-content content ">
        ...
        <div class="card-header content-header">
            <div class="content-header-left col-md-6">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Membership Management</h2>
                        <!-- <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('manage.membership.index') }}">Home</a>
                                </li>
            ...
            <div class="col-md-6 d-flex align-item-center justify-content-end action-box">
                <div class="mobile-responsive-button">
                    <!-- <button type="button" class="btn common-btn btn-warning waves-effect waves-float waves-light add-membership-plan">
                            ...
                            <div class="d-flex align-items-start justify-content-between mx-0 mb-xxl-0 filter-container">          
                                <div class="dropdown-btn-container">
                                    <div class="input-group input-group-merge table-header-search">
                                        ...
                                        <input type="text" id="search_key" class="form-control" placeholder="Search with Membership Name" aria-label="Search..." maxlength="100">
                                    </div>
    ...
    <div class="modal modal-slide-in fade" id="add-membership-modals">
        <div class="modal-dialog employe-directory-modal-dialog">
            <div class="modal-content employe-directory-modal-content pt-0">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-header">
                    <h5 class="modal-title"><i class="bi bi-pencil-square me-1"></i>Add Membership</h5>
                </div>
                    ...
                    <div class="detail-modal-container rounded-0">
                        ...
                        <form id="addMembershipForm">
                            <div class="row">
                                ...
                                <div class="form-group mb-2 col-md-12">
                                    <label class="form-label required">Fees (in &#8377;)</label>
                                    <div class="input-group">
                                        <span class="input-group-text">&#8377;</span>
                                        <input type="number" class="form-control" name="amount_in_inr" placeholder="Enter Amount"/>
                                    </div>
                                </div>
                                <div class="form-group mb-2 col-md-12">
                                    <label class="form-label required">Fees (in $)</label>
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                        <input type="number" class="form-control" name="amount_in_usd" placeholder="Enter Amount"/>
                                    </div>
                                </div>
                                <div class="form-group mb-2 col-md-12">
                                    <label class="form-label required">Duration (in Days)</label>
                                ...
                                <div class="form-group mb-2 col-md-12">
                                    ...
                                    <textarea name="benefits" class="jqte"></textarea>
                                    <span id="benefits-error" class="error"></span>
                                </div>
                                <div class="form-group mb-2 col-md-12">
    ...
    <div class="modal modal-slide-in fade" id="mebership-detail-modals">
        <div class="modal-dialog employe-directory-modal-dialog">
            <div class="modal-content employe-directory-modal-content pt-0">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-header">
                    <h5 class="modal-title"><i class="bi bi-pencil-square me-1"></i>Update Membership</h5>
                </div>
                <div class="modal-body flex-grow-1">
                        ...
                        <form id="editMembershipForm">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-2 col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="created_on" placeholder="Enter created_on" readonly/>
                                </div>
                                <div class="form-group mb-2 col-md-12">
                                    <label class="form-label">Updated on</label>
                                    <input type="text" class="form-control" name="updated_on" placeholder="Enter updated_on"readonly/>
                                </div>
                                <div class="form-group mb-2 col-md-12">
                                    <label class="form-check-label mb-50">Is Active?</label>
                                    <div class="form-check form-check-primary form-switch">
...
<script src="{{ asset('new_ui/assets/js/admin/membership/index.js') }}?v={{ time() }}"></script>
