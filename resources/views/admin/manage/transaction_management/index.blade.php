        ...
        <div class="modal-dialog employe-directory-modal-dialog sidebar-md">
            <div class="modal-content employe-directory-modal-content pt-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mt-2">
                            ...
                            <div class="d-flex gap-1">
                                ...
                                <i class="bi bi-copy cursor-pointer copy-order-id"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mt-2">
                            ...
                            <div class="d-flex gap-1">
                                ...
                                <i class="bi bi-copy cursor-pointer copy-transaction-id"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mt-2">
                            <h5 class="mb-0">Discount Amount:</h5>
                    ...
                    <div class="col-md-6">
                        <div class="mt-2">
                            <h5 class="mb-0">Tax Id:</h5>
                            <p class="card-text tax_id"></p>
                        </div>
                        <br/>
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            ...
                            <p class="card-text company_address"></p>
                        </div>
                    </div>
                </div>
