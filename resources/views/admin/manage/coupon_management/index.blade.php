                    ...
                    <div class="detail-modal-container rounded-0">
                        ...
                        <form id="addCouponForm">
                            <div class="row">
                                ...
                                <div class="form-group mb-2 col-md-12">
                                    <label class="form-label required">Minimum Amount to Purchase</label>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="input-group">
                                                <span class="input-group-text">&#8377;</span>
                                                <input type="number" class="form-control" name="minimum_purchase_inr" placeholder="Enter Amount in (&#8377;)"/>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input type="number" class="form-control" name="minimum_purchase_usd" placeholder="Enter Amount in ($)"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
